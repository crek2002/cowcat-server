package com.example.lyyserverdemo.broadcastreceiver;
...
/**
 * @author Yingyong Lao
 * 创建时间 2022/5/14 11:21
 * @version 1.0
 */
public class LyyServerBroadcastReceiver extends BroadcastReceiver {

    private static final String ACTION = "LyyServerBroadcastReceiver";
    ...
    public LyyServerBroadcastReceiver(ServerStateListener serverStateListener) {
