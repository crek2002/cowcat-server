...
import com.example.lyyserverdemo.lyyframework.LyyApplication;
...
public class FileUtils {
    ...
    public static final String filePath=Environment.getExternalStorageDirectory()+File.separator+"CowcatServer";//文件保存的位置
    ...
    public static File createRandomFile(MultipartFile file) {
        ...
        return new File(LyyApplication.getInstance().getRootDir(), uuid + "." + extension);
    }

    public static File createUploadFile(MultipartFile file) throws IOException {
